...
- **다음 단위(M0→M1)**:
  ...
  - 구조 권장: MainWindow.xaml.cs 비대화(**970줄**, 2차 감사 F1 god object) → **`Nexa.ViewModels`(net8.0) 분리**(맥 빌드/테스트, MVVM) + `bool left` 이중화를 `PanelView` 객체로 소거(트랙 B) — [11](11-dev-environment.md) §6-1.
