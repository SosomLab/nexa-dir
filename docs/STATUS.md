...
**[TODO.md](TODO.md)**(할 일 백로그·범위 산정, living) · **[BUGS.md](BUGS.md)**(알려진 이슈) · **[BRANCHES.md](BRANCHES.md)**(브랜치 기록 — 생성/병합/삭제 이력) · CLAUDE.md(이식 메모리) · 00 비전 · 01 아키텍처 · 02 로드맵 · 03 기능 · 04 트렌드백로그 ·
