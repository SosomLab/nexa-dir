...
> 갱신: 2026-07-02 (KST) · 단계: **M1 진행** — 데이터흐름(F1~5)+레이아웃(F6~9)+**플래그십 초안**(인라인 펼침·컬럼 F10 / 선택 F11·F17) + **패널 탭**(F20·닫기 F22) + **계층 경로 바 `NexaPathBar`**(F23) + 네비(F13·F19·F21) 구현(**F1~F23**, [19](19-implemented-features.md)). 기본 폰트 Segoe UI. 다음=**코어 VisibleRow 스트림(C1)**·`Nexa.ViewModels` 분리 · 코어 9 tests green
...
- **레이아웃·플래그십 초안 진행** ✅ (F7~F17, 상세 [19](19-implemented-features.md)):
  ...
  | UX (폰트) | **기본 폰트 = Segoe UI**(App 리소스), 아이콘=Segoe MDL2 |
