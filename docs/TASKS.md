...
| NAV-HOVER | 네비 버튼 상태 식별 디자인(hover 하이라이트·pressed 강조·disabled 흐림 — NavBtnStyle 템플릿) | ✨ | 2026-07-11 (사용자) | 2026-07-11 | 스크린샷 | 2026-07-11 | ✅ 0.3.4 |
| NAV-CLICK | **네비 버튼 클릭 무동작 진범** — 패널 press 시 그리드 포커스 회수가 ButtonBase pressed 리셋 → `IsWithinButton` 제외 | 🐞 | 2026-07-11 (사용자: 호버 됨·클릭만 안 됨) | 2026-07-11 | 합성 실클릭 before/after(0회→발화) | 2026-07-11 | ✅ 0.3.5 |
| NAV-UPFOCUS | 상위 이동 시 선택 소실·최상단 스크롤 — **watcher 자동 갱신이 선택·캐럿·스크롤 파괴** → ReloadPanel 보존→복원(무간섭) | 🐞 | 2026-07-11 (사용자) | 2026-07-11 | UIA GoUp+watcher 유발·스크린샷 | 2026-07-11 | ✅ 0.3.5 |
...
| PATH-SUG | **경로바 편집 자동완성**(탐색기식 폴더 제안 — 순수 `PathSuggestions`+공급자 주입·팝업 UI·↑/↓/Enter/ESC/클릭) — 2차: ↑ 입력 복원·PreviewKeyDown·TextChanged 병합 트랩 · 3차: 항목 폰트(컨테이너 로컬 주입) | ✨ | P1 | 2026-07-11 (사용자) | — | 2026-07-11 (PR#22~24) | xUnit 7(총 88)·UIA·사용자 스크린샷 | 2026-07-11 | ✅ 0.3.6 | TODO §9-5 · docs/27 후속 |
