...
| PKG-1/2/3 | **패키징 1차 — 포터블**(경로 분기 `AppPaths`+`portable.ini` · `make-portable.ps1` self-contained zip · CI `package` job) | ✨ | P1 | 2026-07-10 | [docs/12](12-packaging-portable.md) | 2026-07-10 | 자체검증(zip 실행·data\ 영속·%APPDATA% 미오염) | 🚧 | TODO §9-5 · MSIX=PKG-4(인증서 결정 대기) |
