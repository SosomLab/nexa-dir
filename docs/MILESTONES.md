...
| **M1** | ★ 1순위 묶음 — 경로 바·탭/듀얼·플래그십(인라인 트리+교차선택)·컨텍스트 메뉴·퀵 런처 | 🚧 **후반** — 셸 컨텍스트 메뉴 S1 ✅(경로복사 제자리대체 포함, S2/S3 잔여)·Undo/Redo ✅·러버밴드 ✅·테마 ✅·**설정 시스템 PREF-1 ✅**·**설정 창 재구성+글꼴 5종+밀도 ✅**·**i18n(외부 `.lang`+전면 이관) ✅**·**도구 모음+퀵 런처 슬라이스1 ✅**(CRUD/단축키 후속) |
