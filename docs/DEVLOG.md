...
- **네비 버튼 상태 식별 디자인**(`fix/navbtn-hover-affordance`): 사용자 재리포트(설치본 0.3.3=상태 동기 미포함에서 no-op 버튼이 활성처럼 보임) → NavBtnStyle 템플릿화 — hover 하이라이트·pressed 강조색·**disabled 글리프 0.3 흐림**. PR#18과 함께 0.3.4 릴리스. 상세 [journal/2026-07-11.md](journal/2026-07-11.md).
