...
전체 코어 테스트: `cd core && cargo test --workspace` (현재 **21 tests green** — nexa-core 2·nexa-vfs 3·nexa-tree 11·nexa-interop 5, + 벤치 1 ignored, **맥/Windows 공통**) · 앱 빌드/실행: [18](18-build-and-test.md) §2·§6.
