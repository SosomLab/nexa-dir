...
| 문서 | 내용 |
| --- | --- |
| [docs/STATUS.md](docs/STATUS.md) | ★ 진행 현황 한눈 정리 (결정·요구·마일스톤·다음 단계) |
...
| [docs/14-context-sharing.md](docs/14-context-sharing.md) | 컨텍스트 공유 & 비공개 정보 가이드 |
| [docs/15-dev-methodology.md](docs/15-dev-methodology.md) | 개발 방법론 (작은 단위·단위별 커밋·프로토타이핑) |
| [docs/16-project-structure.md](docs/16-project-structure.md) | 프로젝트 구조 (스캐폴딩 폴더/파일별 목적) |
| [docs/17-licensing-activation.md](docs/17-licensing-activation.md) | 라이선스 정품 인증 (오프라인/온라인, Ed25519) |
| [docs/24-search-everything.md](docs/24-search-everything.md) | Everything식 인스턴트 파일 검색 (M3) |
| [docs/25-bulk-rename.md](docs/25-bulk-rename.md) | 일괄 이름변경 (Path Finder식 배치 리네임) |
| [docs/27-pathbar-component.md](docs/27-pathbar-component.md) | NexaPathBar 계층 경로 바 컴포넌트 설계 |
| [docs/28-startup-memory-optimization.md](docs/28-startup-memory-optimization.md) | 실행 용량(메모리·기동) 최적화 할 일 (A/B/C/D) |
